...
public class G4 extends World implements ApplicationListener {
	public static int levelNum = 4;
	public static Level level;
//	public static float pStartX, pStartY;

	public static float pStartX = 100;
	public static float pStartY = 500;
	
	public G4(int id, GameContainer gc) throws SlickException {
		super(id, gc);
		gc.setShowFPS(true);
		Main.w = this;
		loadLevel();
