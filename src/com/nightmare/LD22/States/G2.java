...
import com.nightmare.LD22.Entitys.OpenGate;
...
public class G2 extends World implements ApplicationListener {
	public static int levelNum = 2;
	public static Level level;
	public static float pStartX = 650;
	public static float pStartY = 500;

	public G2(int id, GameContainer gc) throws SlickException {
		super(id, gc);
		gc.setShowFPS(true);
		Main.w = this;
		loadLevel();
